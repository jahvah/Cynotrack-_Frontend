...
if (!defined('BASE_URL')) define('BASE_URL', '/cynotrack/user/AdminUser/');
    ...
    <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex-shrink-0 flex items-center w-1/4">
                <a href="<?= BASE_URL ?>AdminDashboard.php" class="text-xl font-bold tracking-tight text-white hover:text-green-400 transition flex items-center">
                    Cyno<span class="text-green-400">Track</span> 
                    <span class="hidden lg:inline-block text-[10px] ml-2 opacity-50 uppercase tracking-widest font-black border border-white/20 px-2 py-0.5 rounded">Admin</span>
                </a>
            </div>
