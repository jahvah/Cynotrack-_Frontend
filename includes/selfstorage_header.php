...
if (!defined('BASE_URL')) define('BASE_URL', '/cynotrack/user/SelfStorageUser/');
    ...
    <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex-shrink-0 flex items-center w-1/4">
                <a href="<?= BASE_URL ?>SelfStorageDashboard.php" class="text-xl font-bold tracking-tight text-white hover:text-green-400 transition flex items-center">
                    Cyno<span class="text-green-400">Track</span> 
                    <span class="hidden lg:inline-block text-[10px] ml-2 opacity-50 uppercase tracking-widest font-black border border-white/20 px-2 py-0.5 rounded">Self Storage</span>
                </a>
            </div>

            <div class="hidden md:flex flex-1 justify-center">
                <div class="flex items-center space-x-1">
                    <?php if ($role === 'self-storage'): ?>
                        <a href="<?= BASE_URL ?>SelfStorageAppointmentCrud/SelfStorageAppointmentIndex.php" class="hover:bg-emerald-900 px-4 py-2 rounded-lg text-sm font-bold transition text-emerald-50">
                            My Appointments
                        </a>
                    <?php endif; ?>
                </div>
