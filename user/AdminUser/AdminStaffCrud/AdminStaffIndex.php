    ...
    <div class="max-w-7xl mx-auto bg-white border border-green-100 rounded-2xl shadow-sm overflow-hidden">
        ...
        <div class="p-6 sm:p-8 border-b border-green-50 bg-white">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h2 class="text-3xl font-bold text-green-900">Staff Management</h2>
                    <p class="text-green-600 font-medium text-sm mt-1">Manage administrative and medical staff access and account permissions.</p>
                </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="AdminStaffCreate.php" class="px-4 py-2 text-sm font-semibold text-white bg-green-600 rounded-lg hover:bg-green-700 transition shadow-md shadow-green-100">
                        + Add Staff Member
                    </a>
                </div>
            </div>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-green-50/50 border-b border-green-100">
                        <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider text-green-700">Staff Member</th>
                ...
                <tbody class="divide-y divide-green-50">
                            ...
                            <tr class="hover:bg-green-50/30 transition">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-[10px] text-green-600 font-medium uppercase tracking-tight">Staff ID: #<?= htmlspecialchars($row['staff_id']); ?></div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end gap-4">
                                        <a href="AdminStaffUpdate.php?id=<?= urlencode($row['staff_id']); ?>" class="text-sm font-bold text-amber-600 hover:text-amber-700 transition">
                                            Edit
                                        </a>
                                        <a href="AdminStaffDelete.php?id=<?= urlencode($row['staff_id']); ?>" 
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center text-green-800/50 italic bg-green-50/10">
        ...
        <div class="bg-green-50/30 px-8 py-4 border-t border-green-50 flex justify-between items-center">
            <span class="text-[10px] text-green-700 font-bold uppercase tracking-widest">Auth Level: Admin</span>
            <span class="text-[10px] text-green-600 italic">Staff Control Center v1.0</span>
        </div>
    </div>
</div>
