...
// Fetch appointment with full recipient info
$stmt = $conn->prepare("
    SELECT
        a.appointment_id,
        a.appointment_date,
  ...
  <div class="max-w-2xl mx-auto">
    ...
    <div class="fade-up d1 bg-white border border-green-100 rounded-2xl shadow-xl shadow-green-100/20 overflow-hidden">
      ...
      <div class="relative bg-gradient-to-r from-green-800 to-emerald-700 px-8 py-6 overflow-hidden">
        ...
        <div class="relative flex items-center justify-between gap-4">
          <div>
            ...
            <h2 class="display-font text-white text-2xl">Update Recipient Appointment</h2>
      ...
      <div class="p-8 space-y-7">
        ...
        <form action="StaffAppointmentRecipientStore.php" method="POST" class="space-y-7">
          ...
          <div class="fade-up d2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div class="bg-gray-50 border border-gray-100 rounded-xl p-4">
                <p class="text-[10px] font-bold uppercase tracking-wider text-gray-400 mb-1">Recipient Name</p>
