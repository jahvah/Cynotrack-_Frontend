...
// Fetch the self-storage appointment with full user info
$stmt = $conn->prepare("
    SELECT
        a.appointment_id,
        a.appointment_date,
        ...
        s.profile_image
    FROM appointments a
    JOIN self_storage_users s ON a.user_id = s.storage_user_id
    WHERE a.appointment_id = ? AND a.user_type = 'storage'
");
...
$typeColor = match($appointment['type']) {
  ...
  <div class="max-w-2xl mx-auto">
    ...
    <div class="fade-up d1 bg-white border border-green-100 rounded-2xl shadow-xl shadow-green-100/20 overflow-hidden">
      ...
      <div class="relative bg-gradient-to-r from-green-800 to-emerald-700 px-8 py-6 overflow-hidden">
        ...
        <div class="relative flex items-center justify-between gap-4">
          <div>
            ...
            <h2 class="display-font text-white text-2xl">Update Self-Storage Appointment</h2>
      ...
      <div class="p-8 space-y-7">
        ...
        <form action="StaffAppointmentSelfStorageStore.php" method="POST" class="space-y-7">
          ...
          <div class="fade-up d2">
            <h3 class="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-3 flex items-center gap-2">
              <span class="w-2 h-2 bg-slate-300 rounded-full"></span> Locked User Details
            </h3>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div class="bg-gray-50 border border-gray-100 rounded-xl p-4">
                <p class="text-[10px] font-bold uppercase tracking-wider text-gray-400 mb-1">User Name</p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
              <div class="bg-gray-50 border border-gray-100 rounded-xl p-4">
                <p class="text-[10px] font-bold uppercase tracking-wider text-gray-400 mb-1">Current Type</p>
                <span class="inline-block px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-wider border <?= $typeColor ?>">
