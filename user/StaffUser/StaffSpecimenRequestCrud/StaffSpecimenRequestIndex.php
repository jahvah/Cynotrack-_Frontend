...
/* ================= ALL RECIPIENT SPECIMEN REQUESTS ================= */
...
<div class="top-bar">
    ...
    <div>
        ...
        <a href="StaffSpecimenRequestRecipientCrud/StaffSpecimenRequestRecipientCreate.php" class="create-btn">
            + Create Request
        </a>
    </div>
</div>
...
<a href="StaffSpecimenRequestRecipientUpdate.php?id=<?= $row['request_id']; ?>" 
class="action-btn edit-btn">Edit</a>

<a href="StaffSpecimenRequestRecipientDelete.php?id=<?= $row['request_id']; ?>" 
...
<?php endwhile; ?>
<?php else: ?>
<tr><td colspan="8">No specimen requests found.</td></tr>
<?php endif; ?>
</table>
